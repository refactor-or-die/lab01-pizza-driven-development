...
def place_pizza_order(pizza_type, address, delivery_time, card_number, user_id):
    ...
    order = PizzaOrderFacade()
    return order.place_order(pizza_type, address, delivery_time, card_number, user_id)
...
class PizzaOrderFacade:
    ...
    def place_order(self, pizza_type, address, delivery_time, card_number, user_id):
        ...
        return {
            "success": True,
            "order_id": delivery_id,  # jeśli success=True
            "pizza_type": pizza_type,
            "price": price,
            "points_earned": points_earned,
            "delivery_time": delivery_time,
            "error": False  # jeśli success=False
        }