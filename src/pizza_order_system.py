...
class Facade:
    ...
    def __init__(self):
        ...
        self.loyalty_points = LoyaltyPointsCalculator()
    ...
    def place_order(self,pizza_type,address,delivery_time,card_number,user_id):
        ...
        price = self.price_calculator.get_price(pizza_type)
        ...
        self.inventory.reserve_pizza(pizza_type)

        delivery_id = self.delivery.schedule_delivery(address, delivery_time)

        points_earned = self.loyalty_points.add_points(user_id,price)
